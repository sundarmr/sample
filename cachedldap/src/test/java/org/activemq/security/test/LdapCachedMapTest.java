...
@ApplyLdifFiles(
        "org/activemq/security/activemq-apacheds.ldif"
)
public class LdapCachedMapTest extends AbstractLdapTestUnit {
    ...
    public void setup() throws Exception {
        ...
        broker = BrokerFactory.createBroker("xbean:org/activemq/security/activemq-apacheds.xml");        
        broker.start();
    ...
    public void testSendReceive() throws Exception {
        ...
        conn.start();
        Queue queue = sess.createQueue("BAR.Any");
    ...
    public void testCompositeSendDenied() throws Exception {
        ...
        Session sess = conn.createSession(false, Session.AUTO_ACKNOWLEDGE);
        conn.start();
        Queue queue = sess.createQueue("BAR.Any,TEST.Any");
